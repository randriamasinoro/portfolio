...
description: Le site que vous consultez, un portfolio Next.js 16 piloté par des fichiers MDX, déployé en continu sur VPS ARM64 via un pipeline sécurisé, et optimisé pour la performance et le SEO.
domains:
  - devsecops
tags:
  - Next.js
...
| Couche | Choix | Raison |
|--------|-------|--------|
| Framework | Next.js 16 (App Router) | Rendu statique + Server Components |

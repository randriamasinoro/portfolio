...
<Callout type="warning">
  Toutes les clés de ce projet sont rédigées dans cette page. Publier une clé privée — même de démonstration — est une faute : elle suffit à usurper un peer. En cas d'exposition accidentelle, la seule réponse correcte est la **rotation** (régénérer la paire et mettre à jour la config).
</Callout>
